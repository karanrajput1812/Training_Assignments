...
class MainMenu implements EmpDAO {
    ...
    public void storeEmployee(Emp emp) {
        try {
            ...
            collection.insertOne(new Document().append("name", emp.name).append("age",emp.age).append("salary", emp.salary).append("designation", emp.designation).append("department", emp.department));
